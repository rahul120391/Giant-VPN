...
public class ConfigParser {
    ...
    //new parser=====================
    public void parseConfigStr(String stringConfig) throws IOException, ConfigParseError {
        // String[] lines = stringConfig.split("\n");
        Scanner scanner = new Scanner(stringConfig);
        //BufferedReader br =new BufferedReader(reader);
        ...
        while (true) {
            ...
            if (scanner.hasNextLine()) {
                line = scanner.nextLine(); //lines[lineno];
            }
            lineno++;
            if (line == null) {
                scanner.close();
            ...
            checkinlinefileStr(args, scanner);
    ...
    //Check  from string array
    private void checkinlinefileStr(Vector<String> args, Scanner br) throws IOException, ConfigParseError {
