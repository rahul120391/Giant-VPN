...
public class OpenVpnManagementThread extends Activity implements Runnable, OpenVPNManagement {
...
//            new Thread(runnable).start();
            ...
            mHandler = new Handler() {
                ...
                public void handleMessage(Message message) {
                    ...
                    Toast.makeText(cc, "---", 50).show();
                    AlertDialog.Builder al = new AlertDialog.Builder(cc);
                    if (currentstate2.equals("TCP_CONNECT"))
                    {
                        al.setTitle("Please wait");
                        al.setMessage("Loading ....");
                        al.show();
                    }

                    if (currentstate2.equals("ADD_ROUTES"))
                    {
                        al.show();
                    }
                    Log.e(" ======== ===========","+++++++++"+currentstate2);
    ...
    public void reconnect() {
        Log.i(" OpenVPNMngTread ", "++++++>>> ");
        signalusr1();
        releaseHold();
    }

    private void processSignCommand(String b64data) {
        Log.i(" OpenVPNMngTread dhs", "++++++>>> ");
