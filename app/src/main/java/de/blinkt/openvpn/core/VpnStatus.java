...
public class VpnStatus {
    ...
    static {
        ...
        logListener = new Vector<LogListener>();
        stateListener = new Vector<StateListener>();
        byteCountListener = new Vector<ByteCountListener>();
        logInformation();
    }
    ...
    private static int getLocalizedState(String state) {
        if (state.equals("CONNECTING")) {
            ...
            try {
                    ...
                    afterlogin.statusVPN="Disconnect";
                    EventBus.getDefault().post(afterlogin.statusVPN);
