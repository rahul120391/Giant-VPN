...
import com.giantvpn.BuildConfig;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    ...
    public void onRevoke() {
        //ServersActivity.statusVPN = "Connect";

        afterlogin.statusVPN="Connect";
        Log.e("== Do ++", "-");
        if(mManagement!=null){
            mManagement.stopVPN();
    ...
    public void showNotification(String msg, String tickerText, boolean lowpriority, long when, ConnectionStatus status) {
        ...
        if (mProfile != null){
            ...
            //Log.i(" OpenVPNService 1 ", ""+getString(R.string.notifcation_title, mProfile.mName));
        }
        else{
            Log.i(" OpenVPNService 2 ", ""+getString(R.string.notifcation_title, mProfile.mName));
    ...
    private int getIconByConnectionStatus(ConnectionStatus level) {
        switch (level) {
            ...
            case LEVEL_WAITING_FOR_USER_INPUT:
                //Log.e(" ++ Sunday USER_INPUT", "");
                return R.drawable.app_icon;
            case LEVEL_CONNECTING_SERVER_REPLIED:
                //Log.e(" ++ Sunday SERVER_", "");
                return R.drawable.app_icon;
    ...
    private void setAllowedVpnPackages(Builder builder) {
        ...
        Log.i("LOLLIPOP"," LOLLIPOP ");
        for (String pkg : mProfile.mAllowedAppsVpn) {
            try {
                if (mProfile.mAllowedAppsVpnAreDisallowed) {
                    builder.addDisallowedApplication(""+mProfile.mAllowedAppsVpn);
                } else {
                    builder.addAllowedApplication(""+mProfile.mAllowedAppsVpn);
                }
            } catch (PackageManager.NameNotFoundException e) {
                mProfile.mAllowedAppsVpn.remove(""+mProfile.mAllowedAppsVpn);
                VpnStatus.logInfo(R.string.app_no_longer_exists, ""+mProfile.mAllowedAppsVpn);
            }
        }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent == null) {
            ...
            mProfile = (VpnProfile) intent.getSerializableExtra("profile");
        ...
        if (!mOvpn3) {
            ...
            if (ovpnManagementThread.openManagementInterface(this)) {
                ...
                Log.e(" === Dismiss 6", mOvpn3 + "-" + intent + "-" + startId);
            } else {
                return START_NOT_STICKY;
            }
        }
    ...
    public void setLocalIP(String local, String netmask, int mtu, String mode) {
       ...
       if (mLocalIP.len <= 31 && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            System.out.println("lollipop workaroundd");
